...
public class QuoteServiceAPI {
	...
	@ApiMethod(name="add")
	public Quote addQuote(@Named("id") Integer id, @Named("author") String author, @Named("message") String message) 
	...
	public List<Quote> getQuoesByAuthor(@Named("author") String author) {
